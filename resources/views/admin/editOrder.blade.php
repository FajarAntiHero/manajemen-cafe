...
@section('title', 'McCafe - Edit Order')
@section('page-name') Edit Order @endsection
...
<div x-data="{
    ...
    async getItems() {
        const res = await fetch('{{ route('admin.orders.items', $order->id) }}');
        ...
        console.log('ini adalah item', this.items);
    },
